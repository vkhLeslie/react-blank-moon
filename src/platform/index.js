...
var functions = {
     ...
     * @return {*|promise}
     */
    singleMideaChat:function(uid,username,appkey){
        return functions.callApi(_MIDEA_COMMON,"chatMessage", [uid,username,appkey]);
    },
      /**
     * 美信H5应用跳转到指定服务号
     * @return {*|promise}
     * "MideaCommon", "openServiceNo", [127]
     */
    openServiceNo:function(serviceNo){
        return functions.callApi(_MIDEA_COMMON, "openServiceNo", [serviceNo]);
    },
    /**
     * 显示菜单
     * @return {*|promise}
